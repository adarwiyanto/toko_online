...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    foreach ($items as $item) {
      ...
      if (abs($qtyReceived - $qtySent) > 0.05 && $note === '') {
