...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    if ($action === 'set_target') {
      ...
      $qty = round(max(0, (float)($_POST['target_qty'] ?? 0)), 1);
